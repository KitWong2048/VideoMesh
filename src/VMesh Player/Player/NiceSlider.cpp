...
#define ON_WM_MOUSEHOVER() { WM_MOUSEHOVER, 0, 0, 0, AfxSig_vv, (AFX_PMSG)(AFX_PMSGW)(void (AFX_MSG_CALL CWnd::*)(void))&OnMouseOver }, 
...
void CNiceSliderCtrl::OnMouseOver(UINT nFlags, CPoint point)
{
	if (SetThumb(point))
	{
		PostMessageToParent(TB_THUMBTRACK);
