...
// CWMPSettings20 wrapper class

class CWMPSettings20 : public COleDispatchDriver
{
public:
	CWMPSettings20(){} // Calls COleDispatchDriver default constructor
	CWMPSettings20(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CWMPSettings20(const CWMPSettings20& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
