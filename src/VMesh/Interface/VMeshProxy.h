#ifndef _VMESH_PROXY_H
#define _VMESH_PROXY_H
...
/**	@class VMeshProxy
 *	This class provides the wrapping of VMesh for proxy (only support single movie per instance)
 */
class VMeshProxy 
{
public:
	/**	@fn VMeshProxy(string _myIP, int _myPort, string _remoteIP, int _remotePort)
	 *	Constructor
	 ...
	 */
	VMeshProxy(string _myIP, int _myPort, string _remoteIP, int _remotePort, int _localStorageCapacity = LOCAL_STORAGE_CAPACITY, int _proxyExchangeNeighbor = -1);
